...
file_path1 = os.path.join(current_dir,'AB_NYC_2019.csv')
airbnb = pd.read_csv(file_path1)
file_path2 = os.path.join(current_dir,'CAvideos.csv')
ca_videos = pd.read_csv(file_path2)
file_path3 = os.path.join(current_dir, 'GBvideos.csv')
gb_videos = pd.read_csv(file_path3)
file_path4 = os.path.join(current_dir, 'USvideos.csv')
us_videos = pd.read_csv(file_path4)
